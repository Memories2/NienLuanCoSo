                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#" target="_blank">
                                ...
                                <p class="text-secondary mb-0">Đỗ Thành Tài - B2111896</p>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Đỗ Thành Tài - B2111896</a>, All right
                            reserved.</span>
                    </div>
